...
Built specifically for the COSMIC Desktop on Wayland (Pop!_OS), it integrates with the native compositor interfaces via `cos-cli` to provide robust, lightweight window manager utility and session restore.
